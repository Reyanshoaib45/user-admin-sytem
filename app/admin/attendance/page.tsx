        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4 lg:py-6">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl lg:text-3xl font-bold gradient-text">Attendance Management</h1>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <Link href="/admin/attendance/leave-requests">
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-xl border-0 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-purple-500 to-blue-500 text-white">
              ...
              <CardDescription className="text-purple-100">Monitor and manage employee attendance</CardDescription>
